...
function WhatsAppButton({ shopPhone, product }) {
  ...
  const handleClick = () => {
    const formattedPhone = formatPhoneNumber(shopPhone);
  ...
  return (
    ...
    >
      {/*
        ✅ FIXED: Correct official WhatsApp SVG icon (24x24 viewBox).
        The previous path was a simplified/incorrect version that
        rendered a solid blob instead of the WhatsApp logo.
      */}
      <svg
